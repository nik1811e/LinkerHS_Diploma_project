    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            if (MethodUtil.updateAuthInf(session, transaction,
                    ...
                    req.getParameter("dateReg"), req.getParameter("statusO"))) {
                new MailUtil().sendMailRegistration(req.getParameter("email"), req.getParameter("login"), req.getParameter("password"), req);
