...
public class ChangePermissionTest {
    @Mock
    ...
    public void init() {
        ...
        when(mockHttpServletRequest.getParameter("role")).thenReturn("admin");
    }

    @Test
    public void test(){

        new ChangePermission().doPost(mockHttpServletRequest, mockHttpServletResponse);
    }
}
